...
%
% Updates
%   - 20100923 (Nori): now it saves the paramethers (Par) in matlab format (.par.mat)
...
if FileExists([FileBase '.par.mat'])
    ...
    try
        save([FileBase '.par.mat'],'Par')
    catch
        warning('could not save .par.mat file, check writing permissions');
    end
end
