...
% % Early return when using MCOS graphics since v6 zooming is always
% % disabled.
...
function scribeFigChildAdded(~,event,fig)
...
% turn off datacursormode.
function scribeFigChildRemoved(~,event,fig)
...
function scribeFigAxChildAdded(~,event,fig)
...
% turn off zoom and rotate3d
function scribeFigAxChildRemoved(~,event,fig)
