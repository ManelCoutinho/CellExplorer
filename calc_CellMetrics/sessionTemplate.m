...
defaults.extracellular.leastSignificantBit = 0.195; % (in �V) Intan = 0.195, Amplipex = 0.3815
...
if ~isfield(session,'extracellular') || ~isfield(session.extracellular,'chanCoords') 
    ...
    session.extracellular.chanCoords.verticalSpacing = 10; % (�m) Vertical spacing between sites.
end
